...
//En la primera anotación implementamos SPRING DATA JPA (le damos tres datos/atributos:
// 1 basePackages -->las interfaces que tiene que implementar
// 2 -->le damos el nombre del método factory
// 3 --> nombre del método que se encarga de la transacionalidad
//habilita la transaccionalidad usando anotación @Transactional
//Le decimos en la tercera anotación en qué paquetes están las clases que tiene que instanciar. EN ESTE CASO TAMBIÉN EL MAPEADOR
//En la cuarta anotación, le decimos a spring que estamos ante una clase de configuración
@EnableJpaRepositories(basePackages ="dao", entityManagerFactoryRef = "factory", transactionManagerRef = "txManager")
@EnableTransactionManagement 
@ComponentScan(basePackages = {"service.implementation","service.mappers"})
@Configuration
